...
use Vokuro\DataBase\RedisController;
use Vokuro\Logging\Logging;
use Vokuro\Common\Common;
use Vokuro\Phpmailer\Mail;
...
$di->set('pdo', function () {
    return new PdoController();
});
$di->set('redisHelper', function () {
...
$di->set('commonFunction', function () {
    return new Common();
});