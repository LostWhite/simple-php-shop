...
/* popinfo */
.popinfo{display:none;position:absolute;top:30px;background:url(img/star/infobox-bg.gif) no-repeat;padding-top:8px;width:192px;margin-left:-14px;}
.popinfo .info-box{border:1px solid #f00;border-top:0;padding:0 5px;color:#F60;background:#FFF;}
.popinfo .info-box div{color:#333;}
.rater-click-tips{font:12px/25px;color:#333;margin-left:10px;background:url(img/star/infobox-bg-l.gif) no-repeat 0 0;width:125px;height:34px;padding-left:16px;overflow:hidden;}
.rater-click-tips span{display:block;background:#FFF9DD url(img/star/infobox-bg-l-r.gif) no-repeat 100% 0;height:34px;line-height:34px;padding-right:5px;}
.rater-star-item-tips{background:url(img/star/star-tips.gif) no-repeat 0 0;height:41px;overflow:hidden;}
.cur.rater-star-item-tips{display:block;}	
.rater-star-result{color:#FF6600;font-weight:bold;padding-left:10px;float:left;}
</style>

		<script src="http://localhost/bbs_new/public/js/jquery1.9.js"></script>
        <script src="http://localhost/bbs_new/public/js/dialog.js"></script>
        <script src="http://localhost/bbs_new/public/js/bootstrap.js"></script>
        <script src="http://localhost/bbs_new/public/js/NovComet.js"></script>
        <!--<script src="/public/js/layer/layer.min.js"></script>-->
        <script src="http://localhost/bbs_new/public/js/jquery-ui-1.10.4.custom.min.js"></script>
        <script src="http://localhost/bbs_new/public/js/check.js"></script>
<script type="text/javascript">
 ...
 jQuery.fn.rater	= function(options) {
	...
	var settings = {
		...
		imageAll :'img/star/stars-all.gif',
		defaultTips :true,
		clickTips :true,
		width	: 24,
		height	: 24
	...
	content.find('.rater-star-item').mouseover(function() {
		...
		if (typeof settings.title_format == 'function') {
			...
			$("#eval_score").val(current_value);
			//alert($("#eval_score").val());
		}
...
$(function(){
	...
	info_format	: function(value) {
		...
		switch (value) {
			case 1 : 
				info	= '<div class="info-box">1分&nbsp;很不满意<div>太令人失望了！</div></div>';
				break;
			case 2 : 
			...
			case 4 : 
				...
				break;
			case 5 : 
				info	= '<div class="info-box">5分&nbsp;非常满意<div>我很喜欢！太棒了！</div></div>';
				break;
			default :
				info = value;
				break;
	...
	<body>
		...
		<form action="" id="" method="post">
		  <input type="hidden" name="eval_score"  id="eval_score" />  
